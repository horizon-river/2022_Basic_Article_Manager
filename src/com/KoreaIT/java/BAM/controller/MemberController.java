...
public class MemberController extends Controller {
	...
	public void makeTestData() {
		...
		memberService.add(new Member(memberService.setNewId(), Util.getNowDateStr(), "test2", "test2", "이순신"));
		memberService.add(new Member(memberService.setNewId(), Util.getNowDateStr(), "test3", "test3", "김두환"));
	}
